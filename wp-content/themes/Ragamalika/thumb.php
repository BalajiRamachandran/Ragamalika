...
class timthumb {
	...
	public function __construct(){
		...
		$this->debug(1, "Cache file is: " . $this->cachefile);
		return true;
	}
	...
	public function run(){
		if($this->isURL){
			...
			$this->debug(1, "Got request for internal image. Starting serveInternalImage()");
	...
	protected function processImageAndWriteToCache($localImage){
		...
		$this->debug(1, "zoom_crop $zoom_crop");
		// $zoom_crop = 3;
		...
		$this->debug(1, "Mime type of image is $new_width $new_height");
	...
	protected function getLocalImagePath($src){
		...
		/**--Templatic function for multisite BOF--**/
		...
		/**--Templatic function for multisite EOF--**/
